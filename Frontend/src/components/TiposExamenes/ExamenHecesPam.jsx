...
export default function ExamenHecesPam({
  form,
  setForm,
  pacientes,
  selectedPaciente,
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 32, marginBottom: 8 }}>
        <div style={{ flex: 1 }}>
          <label>% Polimorfonucleares</label>
          <input
            className="form-control"
            value={form.pam?.polimorfonucleares || ""}
            onChange={(e) => handleChange(e, "pam", "polimorfonucleares")}
          />
        </div>
        <div style={{ flex: 1 }}>
          <label>% Mononucleares</label>
          <input
            className="form-control"
            value={form.pam?.mononucleares || ""}
            onChange={(e) => handleChange(e, "pam", "mononucleares")}
          />
        </div>
      </div>
    </div>
