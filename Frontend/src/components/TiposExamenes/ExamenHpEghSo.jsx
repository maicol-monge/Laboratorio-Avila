...
export default function ExamenHpEghSo({
  form,
  setForm,
  pacientes,
  selectedPaciente,
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 16, marginTop: 32 }}>
        ...
        <div style={{ flex: 1 }}>
          <label style={{ fontWeight: "bold" }}>SANGRE OCULTA EN HECES</label>
          <input
            className="form-control"
            value={form.sangre_oculta || ""}
            onChange={(e) => handleChange(e, null, "sangre_oculta")}
          />
        </div>
      </div>
    </div>
