...
export default function ExamenSustanPhEgh({
  form,
  setForm,
  pacientes,
  selectedPaciente,
    ...
    <div>
      ...
      <div style={{ marginBottom: 16 }}>
        <input
          className="form-control"
          value={form.ph_heces || ""}
          onChange={(e) => handleChange(e, null, "ph_heces")}
        />
      </div>
      ...
      <div>
        <input
          className="form-control"
          value={form.sustancias_reductoras || ""}
          onChange={(e) => handleChange(e, null, "sustancias_reductoras")}
        />
      </div>
    </div>
  );
